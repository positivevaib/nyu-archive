...
All three programs read input through STDIN. However, only the 'front-end.py' and 'davis-putnam.py' output through STDOUT as 'back-end.py' generates its output directly to the screen.
